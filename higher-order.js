...
//Code Here
let myStrongest = monstersInYourPocket.filter(monster => monster.CP > 200 ? monster : null);
...
let orderTotals = orders.reduce((acc, curr) => {
  acc.push((curr.price * (curr.tax + 1)).toFixed(2));
  return acc;
}, [])
...
let bobsTotal = getSum(purchases);